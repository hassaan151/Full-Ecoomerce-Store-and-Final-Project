...
const Add = ({ token }) => {
  ...
  const [sellingCollection, setSellingCollection] = useState(false);
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      formData.append("sellingCollection", sellingCollection);
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col w-full items-start gap-3">
      ...
      <div className="flex gap-2 mt-2">
        <input
          onChange={() => setSellingCollection(prev => !prev)}
          checked={sellingCollection}
          type="checkbox"
          id="sellingCollection"
        />
        <label className="cursor-pointer" htmlFor="sellingCollection">
          Add to Selling Collection
        </label>
      </div>
